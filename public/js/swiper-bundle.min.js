...
const reviewsSwiper = new Swiper('.reviews-swiper', {
  ...
  navigation: { // Настройка навигации (кнопки вперед/назад)
...
// Если у вас несколько слайдеров на странице, можно инициализировать их все так:
document.querySelectorAll('.swiper').forEach(swiperEl => {
  if (!swiperEl.classList.contains('reviews-swiper')) {
    new Swiper(swiperEl, {
      loop: true,
      slidesPerView: 1,
      spaceBetween: 20,
